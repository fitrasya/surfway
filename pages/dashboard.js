...
export default function dashboard() {
  return (
    <Layout>
      <div className="grid gap-8 text-white uppercase text-sm grid-cols-3 w-2/3 font-medium">
        <div className="col-span-3 text-xl text-center mb-10">
          Dashboard Survey Kepuasan Pelanggan<br></br>Direktorat Jabatan ASN
        </div>
        <Link href={"/pertanyaan2"}>
        ...
        <Link href={"/pertanyaan2"}>
          <div className="bg-rose-500 py-2.5 shadow-lg hover:cursor-pointer hover:bg-rose-600 flex justify-center gap-2 text-sm">
            ...
            Kurang Puas
            <div className="bg-rose-100 text-rose-600 px-2 rounded-full">
              17
            </div>
          </div>
        </Link>
        <Link href={"/"} className="col-start-2 mt-10">
